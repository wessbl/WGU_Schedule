 ...
 * @author wessl
 */
public class AppointmentViewController extends WindowChild 
        implements WindowParent, Initializable {
    ArrayList<Object> timeData = new ArrayList<>();
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        SpinnerValueFactory hour_start = new IntegerSpinnerValueFactory(1, 12, 8);
        hour_start.setWrapAround(true);
        spin_hour_start.setValueFactory(hour_start);
        
        SpinnerValueFactory hour_end = new IntegerSpinnerValueFactory(1, 12, 9);
        ...
        SpinnerValueFactory minute_start = new ListSpinnerValueFactory(minutes);
        minute_start.setWrapAround(true);
        spin_minute_start.setValueFactory(minute_start);
        
        SpinnerValueFactory minute_end = new ListSpinnerValueFactory(minutes);
    ...
    private void confirm(MouseEvent event) {
        ...
        data.add("Appointment View Controller");
    ...
    public void receiveData(ArrayList<Object> o) {
        System.out.println("Appt View received data from " + o.get(0).toString());
    }
}
